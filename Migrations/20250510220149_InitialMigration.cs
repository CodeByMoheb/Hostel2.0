        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHostelManager = table.Column<bool>(type: "bit", nullable: false),
                    ManagerLicenseNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckInTime = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CheckOutTime = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    GuestPolicy = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    NoisePolicy = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hostels_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Documents_Hostels_HostelId",
                        column: x => x.HostelId,
                        principalTable: "Hostels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MaintenanceRequests_Hostels_HostelId",
                        column: x => x.HostelId,
                        principalTable: "Hostels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NoticeRecipient", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NoticeRecipient_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_NoticeRecipient_Notices_NoticeId",
                        column: x => x.NoticeId,
                        principalTable: "Notices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NoticeRecipient_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    PaymentProof = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    RoomId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentMeals_MealPlans_MealPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentMealId = table.Column<int>(type: "int", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Type = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MealPayments_StudentMeals_StudentMealId",
                        column: x => x.StudentMealId,
                        principalTable: "StudentMeals",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Hostels_ApplicationUserId",
                table: "Hostels",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequests_HostelId",
                table: "MaintenanceRequests",
                column: "HostelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealPayments_StudentMealId",
                table: "MealPayments",
                column: "StudentMealId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NoticeRecipient_ApplicationUserId",
                table: "NoticeRecipient",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_NoticeRecipient_NoticeId",
                table: "NoticeRecipient",
                column: "NoticeId");

            migrationBuilder.CreateIndex(
                name: "IX_NoticeRecipient_StudentId",
                table: "NoticeRecipient",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentMeals_MealPlanId",
                table: "StudentMeals",
                column: "MealPlanId");
